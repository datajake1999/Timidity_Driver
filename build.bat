...
md X86
cl /nologo -c /D "UNICODE" /D "_UNICODE" /I "driver\include" /I "driver\include\msinttypes" /O2 common\*.c driver\src\*.cpp driver\timidity\*.c
...
del *.obj
cl /nologo -c /D "UNICODE" /D "_UNICODE" /I "driver\include\msinttypes" /O2 common\*.c driver\timidity\*.c mid2wav\*.c
